...
class server_db():
    def __init__(self):
        ...
        self.person_df = pd.DataFrame(columns=['name', 'face_id', 'path','check'])
        ...
        self.visualized_df = pd.read_csv("./csvfile/visualized_log.csv")

    def upload_file(self,local_path,what):
        # Upload
        csv_path = '/home/hogi/project/project1/data/'
        img_path = "/home/hogi/project/project1/answer/"
