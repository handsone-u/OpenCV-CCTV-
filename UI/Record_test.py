...
#CCTV_IP_ADD = "192.168.20.56:554"
csv_path = '/home/hogi/hdd/csvfile/'
CCTV_df = pd.read_csv(csv_path+'cctv_file.csv')
CCTV_IP_ADD = CCTV_df.loc[CCTV_df.first.vaild_index()].at["CCTV IP Address"]
print(CCTV_IP_ADD)

cap = cv2.VideoCapture("rtsp://" + CCTV_id + ":" + CCTV_pass + "@" + CCTV_IP_ADD
+ "/profile2/media.smp")
